...
class EventsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        eventsViewModel=ViewModelProvider(this,viewModelProviderFactory).get(EventsViewModel::class.java)
        val navHostFragment=supportFragmentManager.findFragmentById(R.id.eventsNavHostFragment) as NavHostFragment
